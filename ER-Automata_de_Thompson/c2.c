...
git status // si un archivo esta modificado

git add . | mai.c // agregar uno o la carpeta a subir

git commit -m "mensaje"  // confirmas y agregas un mensaje

git push origin master  // subir los cambios al repositorio

git pull origin master   // bajar cambios del repositorio
